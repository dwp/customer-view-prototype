...
router.all('/get-a-proof-of-benefit-letter/v3-research/research-set-up/PoB-clear-data', function (req, res) {
...
router.all('/get-a-proof-of-benefit-letter/v3-research/list-benefits-answer', function (req, res) {
...
router.post('/get-a-proof-of-benefit-letter/v3-research/cant-get-proof-all-benefits-answer', function (req, res) {
...
// router.post('/get-a-proof-of-benefit-letter/v3-research/notify-info-answers', function (req, res) {
...
//   // has been sent
//   res.redirect('/get-a-proof-of-benefit-letter/v3-research/confirmation');
...
router.all('/get-a-proof-of-benefit-letter/v3-dev/dev-set-up/PoB-clear-data', function (req, res) {
...
// Drop user if they were not invited to use the service
router.post('/get-a-proof-of-benefit-letter/v3-dev/how-did-you-find-out-about-this-service-answer', function (req, res) {
...
// Select which benefit selection page to show based on number of benefits available for user.
router.all('/get-a-proof-of-benefit-letter/v3-dev/list-benefits-answer', function (req, res) {
...
// Display post or home address for SINGLE benefit select page
router.post('/get-a-proof-of-benefit-letter/v3-dev/single-benefits-answer', function (req, res) {
  ...
  if (confirmLetterSend === 'yes' && oOScope.length === 0 && uCBenefit == false)   {
    res.redirect('/get-a-proof-of-benefit-letter/v3-dev/check-your-answers');
  
  } else if (researchSetUpAddress === "post" && doYouWantLetterFor == "yes" && inScope.length === 1)  {
    // Send user to multi address page
    res.redirect('/get-a-proof-of-benefit-letter/v3-dev/where-we-send-your-letter');
    ...
    res.redirect('/get-a-proof-of-benefit-letter/v3-dev/where-we-send-your-letter');
      ...
      res.redirect('/get-a-proof-of-benefit-letter/v3-dev/you-cannot-get-proof-of-benefit-letter.html');
    
  } else if (doYouWantLetterFor == "no") {
        // Send user to can't get letter page
        res.redirect('/get-a-proof-of-benefit-letter/v3-dev/contact-us-for-different-benefit-letter');
  }

})

// Drop user if they state their address is incorrect
router.post('/get-a-proof-of-benefit-letter/v3-dev/send-letter-to-address-answer', function (req, res) {
...
// Place user back into journey from you cant get a proof for all benefits
router.post('/get-a-proof-of-benefit-letter/v3-dev/cant-get-proof-all-benefits-answer', function (req, res) {
...
router.post('/get-a-proof-of-benefit-letter/v3-dev/multi-benefits-answer', function (req, res) {
  ...
  if (confirmLetterSend === 'yes' && oOScope.length === 0 && uCBenefit == false)   {
    ...
    res.redirect('/get-a-proof-of-benefit-letter/v3-dev/you-cannot-get-proof-of-benefit-letter');

  } else if (inScope.length >= 1 && (oOScope.length >= 1 || uCBenefit == true)) {
    res.redirect('/get-a-proof-of-benefit-letter/v3-dev/you-cannot-get-proof-of-all-your-benefits');
...
// // The URL here needs to match the URL of the page that the user is on
// // when they type in their email address
// router.post('/get-a-proof-of-benefit-letter/v3-dev/notify-info-answers', function (req, res) {
...
//   // This is the URL the users will be redirected to once the email
//   // has been sent
//   res.redirect('/get-a-proof-of-benefit-letter/v3-dev/confirmation');
