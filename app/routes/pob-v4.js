...
router.all('/get-a-proof-of-benefit-letter/v4-research/digital/research-set-up/PoB-clear-data', function (req, res) {
...
router.post('/get-a-proof-of-benefit-letter/v4-research/digital/email-address-answer', function (req, res) {

  var notifyEmailAddress = req.session.data['notifyEmailAddress']

  if (notifyEmailAddress === '')   {
    res.redirect('/get-a-proof-of-benefit-letter/v4-research/digital/enter-email');
  
  }  else {
      res.redirect('/get-a-proof-of-benefit-letter/v4-research/digital/email-address-we-send-letter-to');
  }

})


router.post('/get-a-proof-of-benefit-letter/v4-research/digital/email-confirm-answer', function (req, res) {

  var confirmEmailSend = req.session.data['confirmEmailSend']

  if (confirmEmailSend === 'yes')   {
    res.redirect('/get-a-proof-of-benefit-letter/v4-research/digital/do-you-need-letter');
...
router.post('/get-a-proof-of-benefit-letter/v4-research/digital/letter-confirm-answer', function (req, res) {
...
router.all('/get-a-proof-of-benefit-letter/v4-dev/dev-set-up/PoB-clear-data', function (req, res) {
...
// Drop user if they were not invited to use the service
router.post('/get-a-proof-of-benefit-letter/v4-dev/how-did-you-find-out-about-this-service-answer', function (req, res) {

  var howDidYouFindOutAboutThisService = req.session.data['how-did-you-find-out-about-this-service']


  if (howDidYouFindOutAboutThisService === "heard-about-on-phone" || howDidYouFindOutAboutThisService === "job-centre") {
    res.redirect('/get-a-proof-of-benefit-letter/v4-dev/go-to-identity-check');

  } else {
    res.redirect('/get-a-proof-of-benefit-letter/v4-dev/cannot-get-a-proof-of-benefit-letter');
  }
})

// Select which benefit selection page to show based on number of benefits available for user.
router.all('/get-a-proof-of-benefit-letter/v4-dev/list-benefits-answer', function (req, res) {

  var researchSetUpBenefits = req.session.data['researchSetUpBenefits']

  if (researchSetUpBenefits == [] || researchSetUpBenefits == undefined)  {
    res.redirect('/get-a-proof-of-benefit-letter/v4-dev/you-cannot-use-this-service-no-benefits');
    return

  } else if (researchSetUpBenefits.length > 1)  {
      res.redirect('/get-a-proof-of-benefit-letter/v4-dev/select-benefits-you-need-proof-of');

  } else {
      res.redirect('/get-a-proof-of-benefit-letter/v4-dev/do-you-want-a-letter-for');
    }  
...
router.post('/get-a-proof-of-benefit-letter/v4-dev/single-benefits-answer', function (req, res) {
  ...
  if (confirmLetterSend === 'yes' && oOScope.length === 0 && uCBenefit == false)   {
    res.redirect('/get-a-proof-of-benefit-letter/v4-dev/check-your-answers');
  
  } else if (researchSetUpAddress === "post" && doYouWantLetterFor == "yes" && inScope.length === 1)  {
    // Send user to multi address page
    res.redirect('/get-a-proof-of-benefit-letter/v4-dev/where-we-send-your-letter');
    ...
    res.redirect('/get-a-proof-of-benefit-letter/v4-dev/where-we-send-your-letter');
      ...
      res.redirect('/get-a-proof-of-benefit-letter/v4-dev/you-cannot-get-proof-of-benefit-letter.html');
    
  } else if (doYouWantLetterFor == "no") {
        // Send user to can't get letter page
        res.redirect('/get-a-proof-of-benefit-letter/v4-dev/contact-us-for-different-benefit-letter');
  }

})

// Drop user if they state their address is incorrect
router.post('/get-a-proof-of-benefit-letter/v4-dev/send-letter-to-address-answer', function (req, res) {
  ...
  if (confirmLetterSend == "no")  {
    // Send user to contact us page
    res.redirect('/get-a-proof-of-benefit-letter/v4-dev/you-cannot-use-this-service-incorrect-address');
  }
...
// Place user back into journey from you cant get a proof for all benefits
router.post('/get-a-proof-of-benefit-letter/v4-dev/cant-get-proof-all-benefits-answer', function (req, res) {
...
router.post('/get-a-proof-of-benefit-letter/v4-dev/multi-benefits-answer', function (req, res) {
  ...
  if (confirmLetterSend === 'yes' && oOScope.length === 0 && uCBenefit == false)   {
    ...
    res.redirect('/get-a-proof-of-benefit-letter/v4-dev/you-cannot-get-proof-of-benefit-letter');

  } else if (inScope.length >= 1 && (oOScope.length >= 1 || uCBenefit == true)) {
    res.redirect('/get-a-proof-of-benefit-letter/v4-dev/you-cannot-get-proof-of-all-your-benefits');
...
// // The URL here needs to match the URL of the page that the user is on
// // when they type in their email address
// router.post('/get-a-proof-of-benefit-letter/v4-dev/notify-info-answers', function (req, res) {
...
//   // This is the URL the users will be redirected to once the email
//   // has been sent
//   res.redirect('/get-a-proof-of-benefit-letter/v4-dev/confirmation');
