...
router.all('/get-a-proof-of-benefit-letter/download/download-4-SP/research-set-up/PoB-clear-data', function (req, res) {
  ...
  router.post('/get-a-proof-of-benefit-letter/download/download-4-SP/research-set-up/benefits-answer', function (req, res) {
  ...
  res.redirect('/get-a-proof-of-benefit-letter/download/download-4-SP/research-set-up/address');
...
router.post('/get-a-proof-of-benefit-letter/download/download-4-SP/how-did-you-find-out-about-this-service-answer', function (req, res) {
  ...
  if (howDidYouFindOutAboutThisService === "heard-about-on-phone" || howDidYouFindOutAboutThisService === "job-centre")  {
    res.redirect('/get-a-proof-of-benefit-letter/download/download-4-SP/go-to-identity-check');

  } else {
    res.redirect('/get-a-proof-of-benefit-letter/download/download-4-SP/cannot-get-a-proof-of-benefit-letter');
  }
})

// Select which benefit selection page to show based on number of benefits available for user.
router.all('/get-a-proof-of-benefit-letter/download/download-4-SP/list-benefits-answer', function (req, res) {

  var researchSetUpBenefits = req.session.data['researchSetUpBenefits']

  if (researchSetUpBenefits == [] || researchSetUpBenefits == undefined)  {
    res.redirect('/get-a-proof-of-benefit-letter/download/download-4-SP/you-cannot-use-this-service-no-benefits');
    return

  } else if ((researchSetUpBenefits.length > 0) && (inScope.length > 0 ))   {
      res.redirect('/get-a-proof-of-benefit-letter/download/download-4-SP/select-benefits-you-need-proof-of');

  } else if (inScope.length === 0 )  {
    res.redirect('/get-a-proof-of-benefit-letter/download/download-4-SP/you-cannot-get-proof-of-benefit-letter');

  }

})

router.post('/get-a-proof-of-benefit-letter/download/download-4-SP/select-benefits-answer', function (req, res) {

  var doYouWantLetterFor = req.session.data['doYouWantLetterFor']

    if (doYouWantLetterFor === 'no') {
      res.redirect('/get-a-proof-of-benefit-letter/download/download-4-SP/contact-us-for-different-benefit-letter');
    }

    else {
      res.redirect('/get-a-proof-of-benefit-letter/download/download-4-SP/where-we-send-your-letter');
    }

})

router.post('/get-a-proof-of-benefit-letter/download/download-4-SP/select-benefits-answer-change-link', function (req, res) {
...
router.post('/get-a-proof-of-benefit-letter/download/download-4-SP/send-letter-to-address-answer', function (req, res) {
  ...
  if (confirmLetterSend == "no")  {
    ...
    res.redirect('/get-a-proof-of-benefit-letter/download/download-4-SP/digital-or-letter');
  }
...
router.post('/get-a-proof-of-benefit-letter/download/download-4-SP/check-your-answers-answer', function (req, res) {
  ...
  if (digitalOrLetter === 'Posted letter') {
    res.redirect('/get-a-proof-of-benefit-letter/download/download-4-SP/request-complete');
