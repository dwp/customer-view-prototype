...
// * Version 5 - Research - PiP

var inScope = [];  
var uCBenefit = false;
var oOScope = [];

router.all('/get-a-proof-of-benefit-letter/v5-research/pip/research-set-up/PoB-clear-data', function (req, res) {
  ...
  router.post('/get-a-proof-of-benefit-letter/v5-research/pip/research-set-up/benefits-answer', function (req, res) {
  ...
  res.redirect('/get-a-proof-of-benefit-letter/v5-research/pip/research-set-up/address');
...
router.post('/get-a-proof-of-benefit-letter/v5-research/pip/how-did-you-find-out-about-this-service-answer', function (req, res) {
  ...
  if (howDidYouFindOutAboutThisService === "heard-about-on-phone" || howDidYouFindOutAboutThisService === "job-centre")  {
    res.redirect('/get-a-proof-of-benefit-letter/v5-research/pip/go-to-identity-check');

  } else {
    res.redirect('/get-a-proof-of-benefit-letter/v5-research/pip/cannot-get-a-proof-of-benefit-letter');
  }
})

// Select which benefit selection page to show based on number of benefits available for user.
router.all('/get-a-proof-of-benefit-letter/v5-research/pip/list-benefits-answer', function (req, res) {
...
router.post('/get-a-proof-of-benefit-letter/v5-research/pip/send-letter-to-address-answer', function (req, res) {
  ...
  if (confirmLetterSend == "no")  {
    ...
    res.redirect('/get-a-proof-of-benefit-letter/v5-research/pip/you-cannot-use-this-service-incorrect-address');
  }

  else {
    // Send user to check answers
    res.redirect('/get-a-proof-of-benefit-letter/v5-research/pip/check-your-answers');
  }

})


// * Version 5 - Research - No PiP
